...
Item {
    ...
    // Static Catppuccin Mocha palette (replaces MatugenColors)
                    ...
                    ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        anchors.centerIn: parent
                                        spacing: 6
                                        Text { text: root.musicData.deviceIcon || "󰓃"; color: root.mauve; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 14 }
                        ...
                        RowLayout {
                            ...
                            MouseArea {
                                ...
                                Text { anchors.centerIn: parent; text: ""; color: parent.pressed ? root.text : root.overlay2; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 24 }
                            }
                            MouseArea {
                                id: playPauseBtn
                                width: 50; height: 50
                        ...
                        Row {
                            ...
                            Repeater {
                                ...
                                delegate: Item {
                                    ...
                                    property real dist: root.eqLightningProgress - (sliderDelegate.modelData.idx - 1)
                                    ...
                                    ColumnLayout {
                                        ...
                                        Slider {
                                            ...
                                            Connections {
                                                ...
                                                function onEqDataChanged() {
                                                    if (!eqSlider.pressed) {
                                                        if (root.eqData && root.eqData["b" + sliderDelegate.modelData.idx] !== undefined) {
                                                            var p = Number(root.eqData["b" + sliderDelegate.modelData.idx]);
                                            ...
                                            onPressedChanged: {
                                                if (!pressed) {
                                                    var temp = Object.assign({}, root.eqData);
                                                    temp["b" + sliderDelegate.modelData.idx] = Math.round(value);
                                                    temp.preset = "Custom";
                                                    temp.pending = true;
                                                    root.eqData = temp;
                                                    ...
                                                    root.execCmd(`$HOME/.config/quickshell/music/equalizer.sh set_band ${sliderDelegate.modelData.idx} ${Math.round(value)}`);
                                                }
                                            }
                                            ...
                                            handle: Rectangle {
                                                ...
                                                Rectangle {
                                                    ...
                                                    height: width
                                                    radius: width / 2
                                                    color: parent.catColors[sliderDelegate.index % parent.catColors.length]
                                        ...
                                        Text {
                                            text: sliderDelegate.modelData.lbl
                                            color: root.overlay1
                                            font.family: "JetBrainsMono Nerd Font"
                                            font.pixelSize: 10
                                            font.bold: true
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Repeater {
                                ...
                                delegate: PresetButton { required property string modelData; name: modelData }
                            }
                        }
                        RowLayout {
                            Layout.fillWidth: true
